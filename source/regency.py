...
class Regency(object):
    ...
    def random_events(self, override={}, style='Birthright', Threshold=50, Regions=None):
        ...
        for event in list(set(temp['Random Event'])):
            ...
            # random_event_blood_challenge(df_temp)
            # elif event == 'Brigandage' or event == 'Monsters':
                # random_event_brigandage_or_monsters(df_temp)
            # elif event == 'Crime/Corruption':
                # random_event_corruption(df_temp)
            # elif event == 'Diplomatic Matter':
                # random_event_diplomatic_mission(df_temp)
            # elif event == 'Festival':
                # random_event_festival(df_temp)    
            # elif event == 'Feud':
                # random_event_feud(df_temp)    
            # elif event == 'Great Captain or Heresy':
                # random_event_great_captain_or_heresy(df_temp)
            # elif event == 'Great Captain or Heresy':
                # random_event_great_captain_or_heresy(df_temp)
            # elif event == 'Intrigue':
                # random_event_intrigue(df_temp)
            # elif event == 'Magical Event':
                # random_event_magical_event(df_temp)    
